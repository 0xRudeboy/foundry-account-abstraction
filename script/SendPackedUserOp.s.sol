...
contract SendPackedUserOp is Script {
        ...
        returns (PackedUserOperation memory)
    {
        ...
        // Here if there are wallets in the --account section, by passing an address foundry is smart enough to check if its available and use that wallet to sign without disclosing the private key
        uint8 v;
        bytes32 r;
        bytes32 s;
        ...
        userOp.signature = abi.encodePacked(r, s, v); // Keep track of the order here
